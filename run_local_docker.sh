...
# Script to build and run the Test Skill Gen 1772170517 MCP Server locally in Docker
...
IMAGE_NAME="test-skill-gen-1772170517-mcp-server"
CONTAINER_NAME="test-skill-gen-1772170517-mcp-local"
HOST_PORT=${PORT:-8000}
CONTAINER_PORT=${PORT:-8000}

echo -e "${BLUE}🚀 Building and running Test Skill Gen 1772170517 MCP Server...${NC}"
echo
...
if [ ! -f .env ]; then
    ...
    if [ -f .env.example ]; then
        ...
        cat > .env << EOF
# Test Skill Gen 1772170517 MCP Server Configuration
PORT=8000
STAGE=MAINNET
LOG_LEVEL=INFO
...
echo
echo -e "${GREEN}✅ Test Skill Gen 1772170517 MCP Server is running!${NC}"
echo
